...
<head>
    ...
    <link rel="stylesheet" href="styles_history.css">
                    ...
                    <div class="table-wrapper">
                        <table class="table table-sm table-bordered table-striped">
                            <thead>
                                ...
                                <th class="sort asc">Codigo de Paciente</th>
                                <th class="sort asc">Nombre Completo</th>
                                <th class="sort asc">Cédula</th>
                                <th class="sort asc">Fecha de nacimiento</th>
                                <th class="sort asc">Sexo</th>
                                <th class="sort asc">Ocupación</th>
